      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {contacts.map((contact, index) => (
            <div key={index} className="bg-[#092420] p-6 rounded-lg shadow-lg transition-transform transform hover:scale-105 hover:shadow-xl">
              <img
                src={contact.image}
                alt={contact.name}
              ...
              <p className="text-center mt-2">
                Email: <a href={`mailto:${contact.email}`} className="text-cyan-300 underline hover:text-cyan-400">{contact.email}</a>
              </p>
